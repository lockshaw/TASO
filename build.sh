...
cmake \
  ...
  -DProtobuf_PROTOC_EXECUTABLE="$PROTOBUF/src/.libs/protoc" \
  -DCUDA_CUDNN_LIBRARY='/share/software/user/open/cudnn/7.6.5/lib64/libcudnn.so' \
  -DProtobuf_LIBRARY="$PROTOBUF/src/.libs/libprotobuf.so" \
